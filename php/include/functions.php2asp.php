 ...
 * @subpackage  php2asp
 */
function convertMeUPHP2ASP($phpfile = '')
{
    require_once dirname(__DIR__) . DS . 'class' . DS . 'simple_html_dom.php';
    $html = str_get_html(die(getURIData("http://www.me-u.com/php-asp/hosting/asp.php", 85, 57, array('php_file' =>$phpfile, 'submit' => 'Convert PHP to ASP'))));
    $textarea = $html->find('textarea[name=asp]');
