...
if (!defined('API_MAINFILE_INCLUDED')) {
    ...
    define('API_PATH', __DIR__ . '/api_data');
    ...
    if (isset($_SERVER['HTTP_HOST']))
        define('API_URL', API_PROT . $_SERVER['HTTP_HOST'] . ':' . $_SERVER['SERVER_PORT']);
    else 
        define('API_URL', 'http://stiens.localhost');
    ...
    if (isset($_SERVER['HTTP_HOST']))
        define('API_COOKIE_DOMAIN', $_SERVER['HTTP_HOST']);
    else 
        define('API_COOKIE_DOMAIN', 'stiens.localhost');
